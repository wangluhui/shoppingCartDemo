...
- (void)viewDidLoad {
    ...
    _btn.frame = CGRectMake(50, self.view.frame.size.height * 0.7, 100, 30);
    ...
    _btn.backgroundColor = customColor;
    [_btn addTarget:self action:@selector(startAni) forControlEvents:UIControlEventTouchUpInside];
...
-(void)groupAnimation
{
    ...
    [layer addAnimation:groups forKey:@"1"];
}
